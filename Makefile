...
destroy-VM1:
	cd VMs/VM1 && vagrant destroy
destroy-VM2:
	cd VMs/VM2 && vagrant destroy
destroy-VM3:
	cd VMs/VM3 && vagrant destroy
destroy-VM1-6:
	cd VMs/VM1-6 && vagrant destroy
destroy-VM2-6:
	cd VMs/VM2-6 && vagrant destroy
destroy-VM3-6:
	cd VMs/VM3-6 && vagrant destroy